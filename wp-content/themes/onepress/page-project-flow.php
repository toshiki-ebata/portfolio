				...
				<main id="main" class="site-main" role="main">
					...
					<div class="flow">
						...
						<ul>
							...
							<li><img class="arrow turn-right" src="/wp-content/themes/onepress/assets/images/project-flow/arrow-right.svg" alt="右矢印"></li>
							<li><img src="/wp-content/themes/onepress/assets/images/project-flow/presentation.png" alt="プレゼンテーション"><div class="cercle"><a class="colorbox" href="#08"><span class="text">08<br>プレゼンテーション</span></a></div></li>
							<li><img class="arrow turn-right" src="/wp-content/themes/onepress/assets/images/project-flow/arrow-right.svg" alt="右矢印"></li>
					...
					<div class="disp-none">
						...
						<div id="04" class="pop-up flex">
							<div class="image-box">
								<img src="/wp-content/themes/onepress/assets/images/project-flow/popup/search.png" alt="土地探し・現場確認">
							</div>
							<div class="flexbox">
						...
						<div id="05" class="pop-up">
							...
							<img src="/wp-content/themes/onepress/assets/images/project-flow/popup/hearing.png" alt="ヒアリング">
							<ul>
						...
						<div id="07" class="pop-up">
							...
							<img src="/wp-content/themes/onepress/assets/images/project-flow/popup/planning.png" alt="プランニング">
							<p>
						...
						<div id="08" class="pop-up">
							<p class="popup-title">プレゼンテーション</p>
							<img src="/wp-content/themes/onepress/assets/images/project-flow/popup/presentation.png" alt="プレゼンテーション">
							<p>
								3Dソフトを使い、細部まで打ち合わせをおこないます。
							</p>
						</div>
						...
						<div id="12" class="pop-up">
							<img src="/wp-content/themes/onepress/assets/images/project-flow/popup/check.png" alt="設計確認">
							<p class="popup-title">設計確認</p>
							<p>
								実施設計図をもとに役所への申請手続きをおこないます。許可がおりましたら工事着工となります。<br>
								ゼロエネ住宅や長期優良住宅の場合は申請にお時間がかかりますので事前にお申し出ください。
							</p>
						</div>
